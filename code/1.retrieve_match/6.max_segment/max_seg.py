...
class PsegMax:
    ...
    def load_entity(self, cities):
        ...
        D = dict(zip(d.keys(), value))

        """ 计算词典中实体的最大长度 """
        max_len = max([len(str(k)) for k in D])
        return D, max_len
    ...
    def max_forward_seg(self, sent):
        ...
        while sent_len > 0:
            ...
            while max_len > 0:
                ...
                if sub_sent in self.entity_dict:
                    ...
                    words_pos_seg.append((sub_sent, tag))  # 匹配上的话就合在一起组成元组
                    break
        ...
        return words_pos_seg  # [('我', 'O'), ('最', 'O'), ('近', 'O'), ('双下肢疼痛', 'SYM'), ('，', 'O'), ('我', 'O'), ('该', 'O'), ('咋', 'O'), ('办', 'O'), ('。', 'O')]
...
if __name__ == "__main__":
    dict_path = "import/KG_auto_1020.xlsx"
    text = "5693的赵呈亮电话是多少张晓筱yanyan.jin@spdbccc.com.cn 开伦职场"
